...
results = [
    ['C1. The identifiers are descriptive', 0, 0, 3, 8, 14,],
    ['C2. The test data is descriptive', 0, 0, 14, 12, 9,],
    ['C3. The test makes sense in the domain', 0, 1, 2, 10, 12,],
    ['C4. The intent of the test is easy to understand', 0, 2, 2, 9, 12,],
]
ax1 = plot_likert_from_dict(plt, results, columns, "MTC", 1)


results = [
    ['C1. The identifiers are descriptive', 0, 4, 1, 10, 10,],
    ['C2. The test data is descriptive', 1, 1, 4, 5, 13,],
    ['C3. The test makes sense in the domain', 0, 2, 4, 6, 13,],
    ['C4. The intent of the test is easy to understand', 0, 4, 2, 5, 14,],
]

plot_likert_from_dict(plt, results, columns, 'Manually written', 2, ax1)

results = [
    ['C1. The identifiers are descriptive', 8, 4, 4, 6, 3,],
    ['C2. The test data is descriptive', 6, 4, 9, 3, 3,],
    ['C3. The test makes sense in the domain', 1, 1, 10, 10, 3,],
    ['C4. The intent of the test is easy to understand', 4, 1, 9, 8, 3,],
]
